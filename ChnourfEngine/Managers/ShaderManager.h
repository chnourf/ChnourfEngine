...
namespace Manager
{
	...
	public:
		...
		void CreateComputeProgram(const std::string& aShaderName, const std::string& aComputeShaderFilename);
		void Initialize();
	...
	private:
		...
		void CreateComputeProgramFromSource(const std::string& aShaderName, const std::string& aComputeShaderSource);
